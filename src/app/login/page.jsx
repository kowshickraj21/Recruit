...
const Page = async ({searchParams}) => {
  ...
  return (
    ...
    <div className='m-auto flex flex-col items-center px-5 lg:px-0 bg-white lg:w-1/4 w-5/6 lg:pt-10 pt-7 pb-5 rounded-md'>
      <h2 className='font-semibold text-2xl mb-8 text-center'>Log In</h2>
      <Login />
